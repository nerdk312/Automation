...
weekly_exercises = {'Week 1':{'Monday':['Front Sled','Tricep Pushdown','Jump Barbell Back Squat(p)','Standing Dumbbell Press(s)','Dumbbell Romanian Deadlift(s)','One Leg Tibialis Raise(s)', 'Max Two Arm Hang'],
                            ...
                            'Tuesday':['Side Sled','Tricep Overhead','Peterson Step Up','Two Leg Nordic Hamstring Curl','Iso Barbell Front squat','Iso Behind The Neck Press','Iso Barbell Bench Press','Iso Barbell Romanian Deadlift', 'Iso Barbell Wrist Flexion','Iso Barbell Wrist Curl','Iso Two Leg Dumbbell Tibialis Raise', 'One arm Hang'],
                    ...
                    'Week 2':{'Monday':['Front Sled','Tricep Pushdown','Barbell Back Squat(s)','Barbell Push Press(p)','Dumbbell Bench Press(s)','Dumbbell Wrist Flexion(s)','Dumbbell Wrist Curl(s)', 'Max Two Arm Hang','Two Legged Box Jump'],
                            ...
                            'Wednesday':['Front Sled','Tricep Pushdown','One Leg Reverse Squat(s)','Pull Ups(s)','ATG Dumbbell External Rotation(s)','Medium Two Arm Hang','Single Leg Hop'],

                            'Thursday':['Front Sled','Tricep Pushdown','Seated Good Morning(s)','Cable Hip Adduction(s)','Cable Hip Abduction(s)','Neck Upwards','Neck Downwards','Heavy Two Arm Hang', 'Max Speed Backwards Sprinting'],
                        ...
                        'Week 3':{'Monday':['Front Sled','Tricep Pushdown','Power Clean(p)','Barbell Military Press(s)','Dumbbell Sumo Deadlift(s)','Single Leg Seated Calf Raise(s)', 'Max Two Arm Hang','Sitting Box Jump'],
                            ...
                            'Thursday':['Front Sled','Tricep Pushdown','Back Barbell Cossack Squat(s)','One Legged Leg Press(s)', 'Push ups(s)','Dumbbell Ulnar Deviation(s)','Dumbbell Radial Deviation(s)','Heavy Two Arm Hang'],
                        ...
                        'Week 4':{'Monday':['Front Sled','Tricep Pushdown','Hack Squat(s)','Barbell Split Jerk(p)','Incline Dumbbell Press(s)', 'Banded Neck Rotation(s)', 'Max Two Arm Hang','Two Leg Depth Jump'],
                            ...
                            'Saturday':['Front Sled','Tricep Pushdown','Back Extension One Leg(s)','Overhead Walk(Double)','Front Barbell Shrug(s)','Back Barbell Shrug(s)','Light Two Arm Hang','Max Approach Jumping'],
                        ...
                        'Week 5':{'Monday':['Front Sled','Tricep Pushdown','Dumbbell Jump Squat(p)','Behind The Neck Press(s)','Barbell Romanian Deadlift(s)','Two Leg Dumbbell Tibialis Raise(s)', 'Max Two Arm Hang','Two Leg Hops'],
                        ...
                        'Week 6':{'Monday':['Front Sled','Tricep Pushdown','Barbell Front Squat(s)','Behind The Neck Push Press(p)','Barbell Bench Press(s)', 'Barbell Wrist Flexion(s)','Barbell Wrist Flexion(s)', 'Max Two Arm Hang','Two Legged Box Jump'],
                            ...
                            'Wednesday':['Front Sled','Tricep Pushdown','Two Legged Reverse Squat(s)','Dumbbell Pullover(s)','External Dumbbell Rotation(s)','Medium Two Arm Hang','Single Leg Hop'],

                            'Thursday':['Front Sled','Tricep Pushdown','Front Barbell Cossack Squat(s)','Barbell Back Row(s)', ,'Hip External and Internal Rotation(s)','Barbell Shoulder Rotation(p)','Heavy Two Arm Hang','Max Speed Backwards Sprinting'],
